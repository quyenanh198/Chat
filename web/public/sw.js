...
self.addEventListener('fetch', (event) => {
  ...
  // /farm/*, /mahjong/*, /blockpuzzle/*, /gunny/* and /garden/* are sibling games served by their own
  ...
  if (['/farm', '/mahjong', '/blockpuzzle', '/gunny', '/garden'].some((prefix) => pathname.startsWith(prefix))) return;
