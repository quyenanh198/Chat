...
self.addEventListener('fetch', (event) => {
  ...
  // /farm/*, /mahjong/*, /blockpuzzle/* and /gunny/* are sibling games served by their own
  ...
  if (['/farm', '/mahjong', '/blockpuzzle', '/gunny'].some((prefix) => pathname.startsWith(prefix))) return;
